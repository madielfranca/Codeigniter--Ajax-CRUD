...
<body>
    <div class="container">
        ...
        <h3>Person Data</h3>
        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Adiconar contato</button>
  ...
  Visualizar
        ...
        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>Nome</th>
                    <th>Email Residencial</th>
                    <th>Email Trabalho</th>
                    <th>Celular</th>
                    <th style="width:210px;">Action1</th>
                </tr>
            </thead>
            <tbody>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Email Residencial</label>
                            <div class="col-md-9">
                                <input name="residencial" placeholder="Last Name" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <label class="control-label col-md-3">nome</label>
            <div>
                <input name="nome" placeholder="nome" class="form-control" type="text" readonly="readonly">
            </div>
        </div>
         <div class="form-group">
            ...
            <div >
                <input name="address" placeholder="Address" class="form-control" readonly="readonly">
            </div>
            </div>
      </div>
      <div class="modal-footer">
